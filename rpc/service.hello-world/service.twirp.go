...
It is generated from these files:
	github.com/samstarling/twirp-test/rpc/service.hello-world/service.proto
*/
package helloworld
...
func NewHelloWorldProtobufClient(addr string, client HTTPClient, opts ...twirp.ClientOption) HelloWorld {
...
func (c *helloWorldProtobufClient) Hello(ctx context.Context, in *HelloReq) (*HelloResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "samstarling.example.helloworld")
...
func NewHelloWorldJSONClient(addr string, client HTTPClient, opts ...twirp.ClientOption) HelloWorld {
	if c, ok := client.(*http.Client); ok {
		client = withoutRedirects(c)
	}
...
const HelloWorldPathPrefix = "/twirp/samstarling.example.helloworld.HelloWorld/"
...
func (s *helloWorldServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/samstarling.example.helloworld.HelloWorld/Hello":
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
